      ...
      <Router>
        <Switch>
          <Route path="/sv">
            ...
            <Project siteLinkCopy="Kolla in sidan" gitLinkCopy="Eller besök github-repot" link="https://featherweather.netlify.app/" github="https://github.com/Hugocsundberg/Feather_Weather" id="3" left={true} name="Feather Weather" imageLong={featherLong} imageMid={featherMid} imageWide={featherWide} body="Feather är en väderapp byggd med react och stylad med styled components. Appen använder sig av Openweathermaps API och är byggd för att kunna användas som en PWA och installeras på enheten."/>
            <Project siteLinkCopy="" gitLinkCopy="Besök github-repot" link="" github="https://github.com/Hugocsundberg/portfolio_react_tailwind" id="4" left={false} name=".this" imageLong={thisLong} imageMid={thisMid} imageWide={thisWide} body="Den här portfolion är byggd i react och stylad med hjälp av Tailwindcss. Textanimationen i topp-sektionen är gjord i anime.js. Parallax effekten är byggd med react hooks, 'scroll' eventlisteners och intersection observer API"/>
          ...
          <Hero bodyProj="Projects" bodyAbout="About me" />
            ...
            <Project siteLinkCopy="Visit the site" gitLinkCopy="Or check out the github repository" link="https://featherweather.netlify.app/" github="https://github.com/Hugocsundberg/Feather_Weather" id="3" left={true} name="Feather Weather" imageLong={featherLong} imageMid={featherMid} imageWide={featherWide} body="Feather is a weather app built with react and styled with style components. The app uses Openweathermap’s API and is built to be used as a PWA and installed on the device."/>
