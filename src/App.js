        ...
        <Switch>
          ...
          <Route path="/sv">
            <div className="bg-gradient-to-b gradient-top">
              ...
              <Project link="https://speed-feed.herokuapp.com/" github="https://github.com/Hugocsundberg/Speed-Feed_Social_Network" id="1" imageLong={speedFeedLong} imageMid={speedFeedMid} imageWide={speedFeedWide} name="Speed Feed" left={true} body="Speed Feed är ett socualt nätverk designat och skapat av mig med native PHP, JS och CSS. Projektet är hostat på Heroku med en Postgres databas." />
            </div>
            ...
            <Project link="" github="https://github.com/Hugocsundberg/portfolio_react_tailwind" id="3" left={true} name=".this" imageLong={thisLong} imageMid={thisMid} imageWide={thisWide} body="Den här portfolion är byggd i react och stylad med hjälp av tailwindCSS. Textanimationen på topp-sektionen är gjord med anime.js. Parallax effekten är byggd med react hooks"/>
